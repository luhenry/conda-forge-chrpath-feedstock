About chrpath-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chrpath-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/chrpath-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/chrpath-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `chrpath` available on your platform:
...
```
mamba search chrpath --channel conda-forge
```
...
```
pixi search chrpath --channel conda-forge
```
...
mamba repoquery search chrpath --channel conda-forge

# List packages depending on `chrpath`:
mamba repoquery whoneeds chrpath --channel conda-forge

# List dependencies of `chrpath`:
mamba repoquery depends chrpath --channel conda-forge
```
